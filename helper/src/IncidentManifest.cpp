...
nlohmann::json MakeCaptureProfileJson(const skydiag::helper::DumpProfile& dumpProfile)
{
  return nlohmann::json{
    ...
    { "include_process_thread_data", dumpProfile.includeProcessThreadData },
    { "include_full_memory_info", dumpProfile.includeFullMemoryInfo },
    { "include_module_headers", dumpProfile.includeModuleHeaders },
    { "include_indirect_memory", dumpProfile.includeIndirectMemory },
    { "ignore_inaccessible_memory", dumpProfile.ignoreInaccessibleMemory },
